...
* Para el **blanco**: [Blanco de plomo]{#bplomo}, usado "con rigor" [@asperen1983algunas] y principalmente para las zonas de luz y paños claros.
* Para las **carnaciones**: mezclas de blanco de plomo con diferentes pigmentos, con más carga del mismo en el caso del cuerpo de Cristo, mostrando la palidez mortal; también en el caso de la Virgen. Recordemos en todo caso la tercera capa de imprimación por encima del dibujo subyacente, que precisamente trata de modelar o dar una base para las mismas.
* **Negro**: en [@asperen1983algunas] afirma "sin determinar", aunque en [@perez1994proceso] dice que son "de origen orgánico".
