...
### Azul de esmalte {#esmalte}

El azul de esmalte, cerúleo o simplemente esmalte [@marai2007arte] es un silicato potásico con óxido de cobalto, con este último metal responsable del color azul; como tal y por su similitud con el cielo se usa habitualmente para expresar la idea de infinito [@clair2018secret].

Palomino [@palomino] lo incluye como "pigmento calcinado" y lo recomienda para la pintura al fresco; no es exclusivo, sin embargo, pudiendo usarse perfectamente en la pintura al óleo e incluso al temple; de hecho, Palomino lo incluye en su categoría "preciso y usual", es decir, imprescindible en cualquier paleta. Pacheco [@pacheco1866arte, p. 423] lo recomienda para pintar "países" (paisajes):

> En este cielo podrá aver nubes alegres, añadiendo a la templa del esmalte un poco de carmín.

### Azul ultramar {#ultramar}

El lapislázuli o azul ultramar también procede de otro mineral del mismo nombre, que se encuentra sobre todo en Afganistán en esta época; al tener que importarse a Europa desde más allá del mar, sobre todo a través de Venecia, recibió ese nombre. El componente que le da color es la *lazurita*, un silicato de aluminio que incluye también sodio y calcio en su composición.
...
Para Palomino [@palomino] se trata de uno de los colores "precisos y usuales", una de las cuatro categorías en las que dividía los pigmentos; esta categoría de pigmentos está compuesta por aquellos necesarios en cualquier paleta por todas las posibilidades que tiene.
...
Acisclo Antonio Palomino de Castro y Velasco (1655-1726) [@palomino] fue un pintor y tratadista nacido en Córdoba que desarrolló su labor dentro del barroco andaluz y español. A partir de su contacto con Luca Giordano, llegado a Madrid para un encargo real, se interesa por la técnica del fresco; a partir de ese momento desarrollaría su labor en diferentes edificios religiosos como la basílica de los Santos Juanes o de los Desamparados en Valencia aparte de la que nos ocupa, la Cartuja de Granada, de las últimas obra en la que trabajaría antes de su muerte (la última sería el sagrario de la Cartuja de El Paular) y, por tanto, una obra en la que reflejaría toda su maestría en la composición, la luz, y dominio de la preparación y la técnica pictórica.
...
* Un enfoscado de yeso sobre el muro de ladrillo, que tendría "yeso, anhidrita, basanita, calcita y cuarzo".
...
**Azul de montaña** (es decir, [azurita](#azurita)), [**azul ultramar**](#ultramar) y [**azul esmalte**](#esmalte). A pesar de que esto no es habitual, para aclarar el azul ultramar o simplemente para economizarlo, lo mezcla con yeso y [albayalde](#bplomo) a partes iguales.
...
El azul esmalte es, aparentemente, usado en el cielo y de forma extensiva. En esta obra se usa para crear un fondo de color frío que lance hacia el primer plano las figuras y las nubes doradas en las que se encuentran, acercándolas a la persona que está abajo en adoración.
...
En cuanto al rojo de minio [@perez1994proceso] se trata de tetróxido de plomo y se obtiene de la misma forma que el blanco de plomo calentándolo; al necesitar este proceso de calentamiento, es uno de los primeros pigmentos generados artificialmente; y esto es así desde Plinio el Viejo, que describía el proceso llamándolo *minium secundarium* (el *primarium* sería el cinabrio).
...
No he encontrado qué tipo de pigmento se usa para realizar el dibujo subyacente, pero en esta época se hacía normalmente con carboncillo. En todo caso, se encuentra al parecer debajo de la imprimatura y encima de la capa de preparación de **gesso**.
...
- **Carmín**, que en este caso se trataría de quermes [@marai2007arte], un azúcar (C~10~H~10~O~8~), un producto que se comercializaba desde Venecia y se producía en varias áreas del Mediterráneo a partir de la hembra de un insecto hemíptero llamado de la misma forma, *quermes*. Para Palomino [@palomino] este tipo de carmín se enmarcaba en de los pigmentos "preciosos, floridos y costosos".
...
Como en la mayoría de esos casos, se usa el [**azul ultramar**](#ultramar) para ese vestido, si bien está combinado con la [**azurita**](#azurita) [@asperen1983algunas]; en ese artículo muestran una microfotografía del manto de la virgen donde se ve una capa a base de azurita mezclada con [blanco de plomo](#bplomo), seguida de dos capas de veladuras que, en este caso, usan lapislázuli^[Asperen et al. [@asperen1983algunas] comentan que esta proporción, 2 de lapislázuli por 1 de azurita, lo hacen mucho más caro que la usada en el Retablo de Gante de Van Eyck, que tiene 3 de azurita por 1 o 2 de [lapislázuli](#ultramar) ].

Van der Weyden intensifica aquí el volumen de la túnica con los detallados pliegues, modelados de forma realista, que dejan en sombra toda la parte izquierda del manto, la más cercana a la calavera de Adán, la más cercana a la muerte. La gradación del oscuro en la parte izquierda del manto con la luz en la parte más cercana a Cristo quiere simbolizar la redención traída por Jesucristo, "la luz del mundo".
...
En el mismo artículo describe como se consigue el color malva del vestido de María Magdalena (en lo que se aprecia en el manto o sobrefalda): Sobre el dibujo y la preparación de color gris carne hay:
...
Velázquez es posiblemente el mejor conocido de los pintores barrocos españoles. Nace en Sevilla al borde del comienzo del siglo XVII [@velazquez], para morir en 1660 en Madrid. Su formación pictórica comienza muy pronto de la mano de Francisco de Herrera el Viejo, para cambiar en breve al taller del pintor y tratadista (y eventualmente suegro) Francisco Pacheco; como dice Palomino [@palomino, p. 479] en el Tomo 2, capítulo CVI, sección I:
...
Tras un viaje a Italia por encargo del rey, para estudiar y adquirir diferentes pinturas, Velázquez se familiariza con los maestros venecianos: Tiziano, Tintoreto y Veronés, de los que adquiere una concepción diferente del color y del empleo de la textura en la aplicación de los mismos, lo que da comienzo a la tercera etapa, caracterizada por su mayor colorismo, pero a la vez por una mayor economía de medios que lleva a la simplificación de la paleta [@gudiolVelazquez].

En esta etapa precisamente se encuadra este cuadro, la Coronación. Según la fuente autoritativa de la web del Prado [@coronacionPrado] se pintó entre los años 35 y 36 para un oratorio de la reina Isabel de Borbón. Wifredo Rincón en su libro [@velazquez], sin embargo, apunta al año 1640-41; Gudiol [@gudiolVelazquez] lo sitúa en la etapa 1631-35; la misma Carmen Garrido en [@GarridoTecnica, p. 447] afirma que según algunos autores podría haber sido pintada a mitad de la década de los 40^[Lo que la situaría *después* de la muerte de la reina para cuyo oratorio había sido creada.].

Se trata, de hecho, de un tema religioso poco habitual en Velázquez, siendo la última pintura religiosa que se le ha atribuido; hasta tal punto es poco habitual, que se atribuyó originalmente a Alonso Cano, aunque desde 1746 no cabe duda de su realización [@GarridoTecnica, p. 447]. La composición recibe inspiración de diferentes obras anteriores [@soria1953venus], principalmente de Durero, pasado quizá por el Greco; también se señala la similitud con "La Cieguecita" de la catedral de Sevilla [@velazquez]; sin embargo, la combinación de estas inspiraciones y la paleta hacen de esta obra algo original y único.
...
El hecho de que la Virgen apunte a su corazón, y que la composición de la ropa de las figuras forme también un corazón en el centro del cual está la misma [@capilla08], apunta a la iconografía del Sagrado Corazón de María, una hipótesis, que más tarde se convertiría en herejía, de que la concepción de Cristo tuvo lugar en el corazón de la Virgen.

A continuación, realizaremos el análisis estratigráfico de la misma, según la documentación hallada.

## Materiales y procedimientos

En este caso tenemos buenas referencias tanto de las técnicas y paletas generales usadas por Velázquez como de la pintura en concreto, principalmente a través de las obras de Carmen Garrido [@GarridoTecnica] [@GarridoGenio], pero también a través de trabajos específicos sobre los pigmentos usados por él [@GUTIERREZNEIRA201313] usando espectroscopía Raman, que confirma en muchos casos las afirmaciones de la anterior.
...
Los lienzos se comenzaron a usar a mediados del siglo XV en combinación con la técnica de óleo, popularizándose desde la ciudad de Venecia. Los lienzos se montaban sobre un bastidor de madera para que quedaran estirados y lisos; a continuación, se les aplicaban las diferentes preparaciones.

Las fuentes [@mckim1993velazquez] remarcan que este lienzo no se haya reentelado, quizás por el estado de olvido en el que ha estado durante muchos años; eso ha permitido precisamente que se conserve en buen estado y que se pueda estudiar en el estado original.
...
Aunque parece que se usó este tipo de imprimación en la etapa inicial, Garrido [@GarridoGenio, p. 16] cuenta que se usan lienzos de alta densidad, con la [tierra roja o almagre](#almagre) aplicada directamente sobre la cola "de guantes", es decir, cola elaborada a partir de piel y huesos animales, en muy posiblemente conejo. Este caso, sin embargo, es especial por el tema y el emplazamiento, así que Garrido comenta [@GarridoGenio, p. 178] que se trata de "blanco de plomo y negro finamente molido", para producir un color cercano al gris; [@mckim1993velazquez] añade que hay trazas de tierra marrón (un óxido metálico de hierro y manganeso) o de sombra.

Lo más interesante, sin embargo, es que Velázquez en esta fase de su obra aplicaba capas muy finas y en algunos casos simplemente dejaba ver la base del lienzo y su trama; así se ve en alguna de las zonas de la imagen, por ejemplo, alrededor del aura de Jesucristo y en las zonas que rodean a las áreas de mayor claridad. 

### Aglutinantes

Como es habitual en la época, se usa aceite de linaza; la única diferencia con otros pintores es que Velázquez lo usa en algunos casos en abundancia y añade calcita para lograr transparencias [@GarridoGenio, p. 17]. Un libro [@mckim1993velazquez, p. 139] menciona que se ha detectado en el cuadro aceite de nuez, aunque no afirma taxativamente que se trate del único aglutinante que usa.
...
Por otro lado, y como es habitual en él, Velázquez usa una paleta muy reducida, compuesta principalmente por azules y rojos. Dedicaremos especial atención a estos tonos agrupando el resto de los colores en un solo apartado al final de esta sección.

#### Azul

Usado de forma predominante en el manto de la Virgen, se entrevén también tonos azulados en el cielo que sirve como fondo.

En el caso del manto de la Virgen, y dado que se trata de un cuadro para un oratorio real, Velázquez no reparó en gastos y usó [azul ultramar](#ultramar) [@GarridoGenio, p. 122], que sigue también la práctica habitual en el manto de las Vírgenes de esta época; el azul es símbolo de majestad y de pureza, lo que refuerza el tema del cuadro. Dado que en la mayoría de los casos Velázquez usaba una sola capa de pintura, es poco probable que se mezclara con azurita.

Por otro lado, en el cielo no es probable que se emplee el mismo pigmento; por el tono debe tratarse de [esmalte](#esmalte) entre los que menciona Garrido [@GarridoTecnica], transmitiendo esa idea de "plano infinito" en la que se sitúan las figuras divinas.

#### Rojo

En este cuadro se usa siempre en combinación con otros colores: los mantos de Cristo y Dios Padre tienen tonos morados o malva; prácticamente igual que la túnica de la Virgen, un poco más clara. También se usa en las carnaciones, desde los saludables coloretes de los angelotes y el rubor de la Virgen hasta el tono más oscuro de Cristo y más pálido que refleja la vejez de Dios Padre. Velázquez pintaba lo que conocía, y los rostros y tonos de piel son tan naturalistas que casi podrían llamarse realistas.

En Toco caso, Garrido [@GarridoTecnica, p. 124] menciona la **laca roja**, y le dedica al "pequeño riachuelo" que forma la figura 17f^[Efecto que, para ser sinceros, es casi imposible de percibir con las imágenes de baja resolución que tenemos, pareciendo prácticamente un límite difuso entre la túnica de la Virgen y la de Dios Padre.]. En el caso de Velázquez parece bastante claro que se trata de *cochinilla*, a la que tendría acceso sin problemas desde la corte, ya que se importaba de Hispanoamérica. El pigmento de la cochinilla es el ácido carmínico, C~22~H~20~O~13~.

También Garrido menciona el uso de **bermellón**, pero por su uso en otras pinturas identificado por espectroscopía Raman [@GUTIERREZNEIRA201313], no parece que se esté usando en este caso. Sí es más probable el [hematites u óxido de hierro rojo](#almagre), principalmente en las carnaciones, donde es bastante evidente; su mezcla con otros colores, principalmente amarillos (también muy probablemente de óxido de hierro) da lugar a los diferentes tonos encarnados que nos encontramos en el cuadro. Este pigmento, identificado en el artículo anterior en "Los Borrachos", es más probable que el bermellón (que también se usa en carnaciones, pero en pinturas más tempranas).

Teniendo en cuenta la paleta limitada de pigmentos de Velázquez, otros colores como el morado (presente en las vestiduras) se obtienen de mezcla de la laca roja con azurita; con estos dos componentes en diferentes proporciones se pueden obtener todo tipo de tonos entre el malva y el morado y ciertamente los que aparecen en el cuadro.

#### Otros colores

Quizás tendríamos que mencionar antes que cualquier otro el [blanco de plomo](#bplomo), que ya se ha mencionado varias veces en la preparación, pero que Garrido también [@GarridoGenio, p. 124] comenta que se aplica "casi en seco" y "en grumos" para los rayos de luz, que también se identifican en la radiografía antes mencionada.

Y ya que mencionamos el blanco, el negro también se usa con profusión, y Velázquez lo aplica tanto en preparaciones como en sombras, usando en general el **negro marfil**, de gran calidad, que da una tonalidad en el óleo más cercana al marrón. El artículo de Gutiérrez Neira [@GUTIERREZNEIRA201313] también lo ha identificado en otras pinturas de Velázquez, mientras que Garrido [@GarridoGenio] se limita a llamarlo "negro orgánico".

El amarillo se hace evidente también, sobre todo en los dorados, y posiblemente también en las carnaciones. No hay nada en la literatura que identifique el amarillo específico usado en esta pintura, aunque una vez más Gutiérrez Neira [@GUTIERREZNEIRA201313] ha identificado el **óxido amarillo de hierro**, *ocre amarillo* o goethita, en realidad el oxihidróxido de hierro FeO~2~H entre los mencionados por Carmen Garrido. También se podría apreciar este color en los cabellos rubios de los *putti*.

Si bien en otros cuadros Velázquez usa *amarillo de plomo y estaño*, no parece que este tenga los elementos en los que los usa habitualmente: ropa, paisajes o piel de animales; también se usa en combinación con la azurita para obtener verde, que no está presente en este cuadro. Aunque no hemos encontrado ninguna mención a su uso, tampoco se puede descartar, así que lo hacemos constar.

Finalmente, el verde que no es muy conspicuo, y de hecho en un primer vistazo no se ve, pero lo cierto es que está nada menos que en la corona que es el tema principal de la Coronación. Por la economía de pigmentos ya mencionada, Velázquez nunca usa un pigmento verde, sino que emplea mezclas de amarillos y azules. En este caso, un libro [@mckim1993velazquez, p 128] afirma que se trata de **laca amarilla**, que según Parrilla-Bou [@marai2007arte], se denomina también *ancorca* o *gutiámbar*.

Es un color artificial según Palomino [@palomino, p. 70], que dice de él:

> También se puede hacer otro verde baxo de ancorca y añil, usando del génuli en vez de blanco

De hecho, es el único pigmento que comentan solo Palomino y Pacheco, y se extrae de la planta llamada gualda; es un flavonoide (de hecho, una laca), con fórmula similar a los carmines: C~15~H~10~O~6~. Igual que los otros pigmentos de los que estamos hablando, se trata, según Parrilla-Bou, de artículos de lujo que tenía que proporcionar el cliente. Junto con el lapislázuli y el carmín de cochinilla, queda establecido con claridad que lo que trató de buscar Velázquez en esta pintura fue una calidad extraordinaria de los pigmentos, que reflejara la devoción a la escena de la coronación de la Virgen^[Y, posiblemente, como se ha comentado arriba, a la cuasi-herejía del Sagrado Corazón de María.] "sin reparar en gastos".

### Conclusiones

Un cuadro excepcional por su estado de conservación y por la economía en el uso de pigmentos, Velázquez es capaz de conseguir mucho con muy poco, consiguiendo expresiones naturalistas y cercanas al espectador, que mueven a la devoción en un entorno privado como el oratorio para el que se creó. Su uso de aglutinantes muestra una maestría en la técnica pictórica que no tiene parangón ni en el siglo de Oro ni más adelante.
