...
- **Carmín**, que en este caso se trataría de quermes [@marai2007arte], un azúcar (C~22~H~20~O~13~), un producto que se comercializaba desde Venecia y se producía en varias áreas del Mediterráneo a partir de la hembra de un insecto hemíptero llamado de la misma forma, *quermes*. 
