...
A diferencia de otros colores que aparecen distribuidos por todo el cuadro, el azul se usa casi exclusivamente en el manto de la Virgen, con el rico azul que es característico tanto en *compianti* como en toda la representación renacentista de la Virgen.

Como en esos la mayoría de esos casos, se usa el **azul ultramar** para ese vestido, si bien está combinado con la **azurita** [@asperen1983algunas]e, en este artículo muestran una microfotografía del manto de la virgen donde se ve una capa a base de azurita mezclada con [blanco de plomo](@bplomo), seguida de dos capas de veladuras que, en este caso, usan lapislázuli.

La *azurita* es un carbonato básico de cobre [@marai2007arte], Cu~3~(CO~3~)~2~(OH)~2~. Es un pigmento común y llamado por eso *azul citramarino* ya que no se tenía que traer, como el lapislázuli, de más allá del mar. Se le llama también "cenizas azules" y es un pigmento de origen natural, común en Alemania. Cennini, que lo llama *azzurro della Magna* (Alemania) dice [@cennino1859libro]:
