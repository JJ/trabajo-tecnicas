...
* Entre esta capa y la siguiente se ha encontrado en el caso de los Santos Juanes una capa de tierra roja o sinopia, que incluye el dibujo preparatorio; como es habitual, el dibujo preparatorio está *por debajo* de la última capa sobre la que se aplica directamente la pintura.
* Una tercera capa de calcita y cuarzo que usa mortero de cal como aglomerante y arena como carga inerte, llamada *estuque* por el propio Palomino. Sobre esta última se aplicaría directamente la pintura.
...
Usa simplemente cal sola, o **blanco de cal**; también se ha encontrado mármol blanco o alab astro molido.

#### Amarillo

Usó **amarillo de Nápoles** u **hornaza**

#### Ocres

**Ocres amarillos o rojizos** y pigmento tierra con carbonato de plomo

#### Azul

**Azul de montaña** y **azul ultramar** y **azul esmalte**. A pesar de que esto no es habitual, para aclarar el azul ultramar o simplemente para economizarlo lo mezcla con yeso y albayalde a partes iguales.

#### Rojo

Carmín y tierra roja
