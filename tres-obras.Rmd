...
- **Carmín**, que en este caso se trataría de quermes [@marai2007arte], un azúcar (C~10~H~10~O~8~), un producto que se comercializaba desde Venecia y se producía en varias áreas del Mediterráneo a partir de la hembra de un insecto hemíptero llamado de la misma forma, *quermes*. Para Palomino [@palomino] este tipo de carmín se enmarcaba dentro de los pigmentos "preciosos, floridos y costosos".
