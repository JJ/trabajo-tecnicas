...
**Figura 3**: Coronación de Velázquez, imagen de dominio público [descargada de Wikimedia Commons](https://www.museodelprado.es/en/the-collection/online-gallery/on-line-gallery/obra/the-coronation-of-the-virgin/) que a su vez la ha incluido desde el Museo del Prado.
...
Velázquez es posiblemente el mejor conocido de los pintores barrocos españoles. Nace en Sevilla al borde del comienzo del siglo XVII [@velazquez]. Su formación pictórica comienza muy pronto de la mano de Francisco de Herrera el Viejo, para cambiar en breve al taller del pintor y tratadista (y eventualmente suegro) Francisco Pacheco.
